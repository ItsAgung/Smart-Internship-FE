...
const TableComponent = ({ data, columns, filterOptions, filterOnChange }) => {
  ...
  return (
    <>
      <div className=" flex gap-5 justify-between">
        ...
        <Select id="filter" name="filter" onChange={filterOnChange}>
      ...
      <div className="mt-5 overflow-auto rounded-md pb-25">
