...
const AdminMaster = ({ title }) => {
  ...
  async function getAdmin() {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_REACT_APP_API}/super_admin/admin`,
        ...
        return (
          <>
            <div className="dropdown dropdown-bottom dropdown-end">
              ...
              >
                {cell.row.original.activation ? (
                  <li>
                    <a
                      onClick={() => {
                        handleActivation(false, cell.row.original.id);
                      }}
                    >
                      Nonaktifkan
                    </a>
                  ...
                  <li>
                    <a
                      onClick={() => {
                        handleActivation(true, cell.row.original.id);
                      }}
                    >
                      Aktifkan
                    </a>
  ...
  function handleActivation(params, id) {
    Swal.fire({
      title: params ? "Aktifkan Akun" : "Nonaktifkan Akun",
      text: params
      ...
      if (result.isConfirmed) {
        ...
        try {
          await axios.put(
            `${import.meta.env.VITE_REACT_APP_API}/super_admin/admin/${id}`,
            data,
            {
              headers: {
  ...
  function handleDelete(id, name) {
    Swal.fire({
      title: "Hapus Akun",
      text: "Apakah Anda Yakin Ingin Menghapus Akun Admin " + name + "?",
      icon: "warning",
      showCancelButton: true,
      confirmButtonColor: "#3085d6",
      cancelButtonColor: "#d33",
    ...
    <>
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="mb-5 btn btn-ghost bg-[#4F6079] hover:bg-[#384353] text-white w-40 btn-sm capitalize text-xs font-light"
        >
          + Tambah Akun
        </button>
      </div>
        ...
        <div className="modal-box overflow-hidden">
          ...
          >
            <div className="flex w-full justify-between items-start mb-8">
              ...
              <TextInput id="nama" name="nama" required className="w-[60%]" />
            </div>
            <div className="flex w-full justify-between items-start mb-8">
              <Label htmlFor="email" value="Email:" />
              <TextInput id="email" name="email" required className="w-[60%]" />
            </div>
            <div className="flex w-full justify-between items-start mb-8">
