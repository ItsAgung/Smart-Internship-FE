...
const Jurusan = ({ title }) => {
  ...
  // Async function to get data jurusan with axios
  async function getJurusan() {
    setIsLoading(true);
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_REACT_APP_API}/jurusan`,
                ...
                >
                  ...
                  <div className="flex w-full justify-between items-start mb-8">
                    <div className="mb-2 block">
                      <Label htmlFor="jurusan" value="Edit Jurusan:" />
                    </div>
                    <TextInput
                      id="jurusan"
                      name="jurusan"
  ...
  async function handleSubmitEdit(e) {
    ...
    try {
      await axios.put(
        `${import.meta.env.VITE_REACT_APP_API}/jurusan/${id}`,
        datajurusan,
        {
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      Swal.fire({
        icon: "success",
        title: "Jurusan Berhasil Diperbarui!",
        timer: 1800,
      }).then(() => {
        getJurusan();
      });
      ...
      <dialog id="modal-tambah" className="modal z-1">
        <div className="modal-box overflow-hidden">
          ...
          >
            <div className="flex w-full justify-between items-start mb-8">
              <div className="mb-2 block">
                <Label htmlFor="jurusan" value="Tambah Jurusan:" />
              </div>
              <TextInput
                id="jurusan"
                name="jurusan"
